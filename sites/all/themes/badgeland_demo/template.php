 ...
 */
function badgeland_demo_preprocess_html(&$variables) {
 ...
 */
function badgeland_demo_process_html(&$variables) {
 ...
 */
function badgeland_demo_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function badgeland_demo_preprocess_maintenance_page(&$variables) {
 ...
 */
function badgeland_demo_process_maintenance_page(&$variables) {
  // Always print the site name and slogan, but if they are toggled off, we'll
  // just hide them visually.
  $variables['hide_site_name']   = theme_get_setting('toggle_name') ? FALSE : TRUE;
  $variables['hide_site_slogan'] = theme_get_setting('toggle_slogan') ? FALSE : TRUE;
 ...
 */
function badgeland_demo_preprocess_node(&$variables) {
 ...
 */
function badgeland_demo_preprocess_block(&$variables) {
 ...
 */
function badgeland_demo_menu_tree($variables) {
 ...
 */
function badgeland_demo_field__taxonomy_term_reference($variables) {
  $output = '';
...
function badgeland_demo_menu_link(array $variables) {
  global $user;
